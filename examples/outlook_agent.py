...
from llmtoolkit.services.outlook_service.outlook_service import OutlookService
...
if __name__ == "__main__":
    ...
    llm_service_interface = LLMInterface([outlook_service])
    ...
    jira_agent_system_message = outlook_service.get_agent_system_message()

    messages = []
    start_message = "Hello! I'm your Outlook Assistant, here to help you manage your emails and calendar efficiently. How can I assist you today?"
